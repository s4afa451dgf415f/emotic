  ...
  <div class="manage">
    ...
    <div class="manage-header">
      ...
      <el-form :inline="true" :model="userForm">
        ...
        <el-form-item>
          <el-button type="primary" :disabled='submitFormDis' @click="onSubmit">查询/刷新</el-button>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  methods: {
    ...
    getList() {
      // 获取的列表的数据
      getEmotic({params: {...this.userForm, ...this.pageData}}).then(({data}) => {
        console.log(data)
